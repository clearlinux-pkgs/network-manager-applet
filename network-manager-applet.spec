...
Source0  : https://download.gnome.org/sources/network-manager-applet/1.8/network-manager-applet-1.8.4.tar.xz
...
%prep
%setup -q -n network-manager-applet-1.8.4
...
export LANG=C
export SOURCE_DATE_EPOCH=1505942169
export AR=gcc-ar
