...
Source0  : https://download.gnome.org/sources/network-manager-applet/1.26/network-manager-applet-1.26.0.tar.xz
...
%prep
%setup -q -n network-manager-applet-1.26.0
cd %{_builddir}/network-manager-applet-1.26.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647958007
...
cp %{_builddir}/network-manager-applet-1.26.0/COPYING %{buildroot}/usr/share/package-licenses/network-manager-applet/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
%find_lang nm-applet
