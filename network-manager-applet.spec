...
Version  : 1.8.2
Release  : 5
URL      : https://download.gnome.org/sources/network-manager-applet/1.8/network-manager-applet-1.8.2.tar.xz
Source0  : https://download.gnome.org/sources/network-manager-applet/1.8/network-manager-applet-1.8.2.tar.xz
...
%prep
%setup -q -n network-manager-applet-1.8.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1505323747
export AR=gcc-ar
