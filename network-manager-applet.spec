...
Source0  : https://download.gnome.org/sources/network-manager-applet/1.8/network-manager-applet-1.8.18.tar.xz
...
%prep
%setup -q -n network-manager-applet-1.8.18
...
export LANG=C
export SOURCE_DATE_EPOCH=1537644350
export AR=gcc-ar
