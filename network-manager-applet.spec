...
Source0  : https://download.gnome.org/sources/network-manager-applet/1.8/network-manager-applet-1.8.0.tar.xz
...
%prep
%setup -q -n network-manager-applet-1.8.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1503332457
export AR=gcc-ar
