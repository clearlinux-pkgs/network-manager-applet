...
Source0  : https://download.gnome.org/sources/network-manager-applet/1.36/network-manager-applet-1.36.0.tar.xz
...
%prep
%setup -q -n network-manager-applet-1.36.0
cd %{_builddir}/network-manager-applet-1.36.0
pushd ..
cp -a network-manager-applet-1.36.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705936577
