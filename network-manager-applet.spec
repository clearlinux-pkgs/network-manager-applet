...
Source0  : https://download.gnome.org/sources/network-manager-applet/1.8/network-manager-applet-1.8.22.tar.xz
...
Requires: network-manager-applet-lib = %{version}-%{release}
...
%prep
%setup -q -n network-manager-applet-1.8.22
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1563208109
...
%files locales -f network-manager-applet.lang
%defattr(-,root,root,-)
